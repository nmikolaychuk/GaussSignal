...
// Gauss_Signal.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGaussSignalApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGaussSignalApp

CGaussSignalApp::CGaussSignalApp()
{
...
// Единственный объект CGaussSignalApp

CGaussSignalApp theApp;


// Инициализация CGaussSignalApp

BOOL CGaussSignalApp::InitInstance()
{
